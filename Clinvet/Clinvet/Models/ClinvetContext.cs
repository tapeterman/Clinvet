...
namespace Clinvet.Models
{
    public class ClinvetContext : System.Data.Entity.DbContext {
        ...
        public void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.HasKey(e => e.IdFornecedorProduto);

                entity.ToTable("fornecedor_produto_servico");

                entity.Property(e => e.IdFornecedorProduto)
            ...
            {
                entity.HasKey(e => e.IdProdutoServicoAgendamentoConsulta);

                entity.ToTable("produto_servico_agendamento_consultas");

                entity.Property(e => e.IdProdutoServicoAgendamentoConsulta)
            ...
            {
                entity.HasKey(e => e.IdProdutoServicoVendaServico);

                entity.ToTable("produto_servico_venda_servico");

                entity.Property(e => e.IdProdutoServicoVendaServico)
            ...
            {
                entity.HasKey(e => e.IdVendaServicoFormaDePagamento);

                entity.ToTable("venda_servico_forma_de_pagamento");

                entity.Property(e => e.IdVendaServicoFormaDePagamento)
